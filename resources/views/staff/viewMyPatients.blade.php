                        ...
                        <table class="table align-items-center mb-0">
                          <thead>
                            <tr>
                              ...
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">House</th>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <p class="text-xs font-weight-bold mb-0">{{$patient->house}}</p>
                              ...
                              <td class="align-middle text-center">
                                <span class="text-secondary text-xs font-weight-bold">{{$patient->email}}</span>
                              </td>
