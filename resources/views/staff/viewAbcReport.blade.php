        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="d-flex align-items-center">
              <p class="mb-0"></p>
              <a href="{{route('staff.viewallabcreports')}}" class="btn btn-primary btn-sm ms-auto">View ABC Reports</a>
            </div>
          </div>
          <div class="card-body">
            <p class="text-uppercase text-sm">ABC Report Information</p>
            <hr>
            <div class="row">
                <form method="POST" action="{{ route('staff.addabcreport') }}">
                    @csrf
                    <div class="mb-3">
