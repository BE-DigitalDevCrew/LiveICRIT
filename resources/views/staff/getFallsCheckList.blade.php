...
<div class="main-content position-relative max-height-vh-100 h-100">
  ...
  <div class="card shadow-lg mx-4 card-profile-bottom">
     ...
     Swal.fire(
     'success',
     'Falls Checklist Added SUccessfully'
         );
         }
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-uppercase text-sm text-center">Falls Checklist</p>
            <hr>
            <div class="row">
                <form method="POST"  action="{{ route('staff.submitfallschecklist') }}">
                    @csrf
